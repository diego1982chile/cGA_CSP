...
public class DNAFragmentAssembling extends Problem {
	...
	public Object eval(Individual ind)
	{
		...
		{
//                        System.out.println("alelo_k:"+this.boolToInt((boolean)ind.getAllele(k)));
//                        System.out.println("alelo_k+1:"+this.boolToInt((boolean)ind.getAllele(k+1))); 
//                        int i= this.boolToInt((boolean)ind.getAllele(k));
//                        int j= this.boolToInt((boolean)ind.getAllele(k+1));                        
//                        System.out.println("[i][j]=["+i+"]["+j+"]");                                              
			Integer i = ((Integer)ind.getAllele(k)).intValue();
			Integer j = ((Integer)ind.getAllele(k+1)).intValue();
