...
Description
Ejecuta un cGA en el que solo se usa seleccion
(ni mutacion ni cruce) y un solo individuo
tiene valor maximo. Para cuando todos los 
individuos alcanzan el maximo valor o cuando 
