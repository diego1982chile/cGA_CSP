...
public class CustomErx implements Operator
{
   public Random r;
   ...
   private void setup(CustomIndividual i1, CustomIndividual i2)
   {
   ...
   public Object execute(Object o)
   {
      ...
      c1 = i1.getIntegerAllele(0);
      c2 = i2.getIntegerAllele(0);
      boolean c3 = i1.getBooleanAllele(0);
      boolean c4 = i2.getBooleanAllele(0);
      
      if (numEdges[c2] < numEdges[c1])
         c1 = c2;

      newInd.setIntegerAllele(0,c1);
      newInd.setBooleanAllele(0,c3);
      kill(c1);
      for (int i=1; i<len; i++)
      {
         c1 = next(c1);
         newInd.setIntegerAllele(i,c1);
         newInd.setBooleanAllele(i,c4);
         kill(c1);
      }
