...
public class CustomInsertionMutation implements Operator
{
    private Random r;
    private EvolutionaryAlg ea;
   
    public CustomInsertionMutation(Random r, EvolutionaryAlg ea)
    {
       this.r = r;
       this.ea = ea;
    }
   ...
   {
   	   CustomIndividual ind = (CustomIndividual)o;
