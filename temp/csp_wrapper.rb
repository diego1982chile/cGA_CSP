...
cmd = "java -jar JCell.jar  #{paramstring} -inst #{cnf_filename} -cutoff #{cutoff_length} -timeout #{cutoff_time} -seed #{seed} -r stats stdout default,best"

filename = "csp_output#{rand}.txt"
